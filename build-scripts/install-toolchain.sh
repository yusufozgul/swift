...
cp /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/17.0.0/lib/darwin/libclang_rt.profile_iossim.a "$FINAL_TOOLCHAIN_PATH/usr/lib/clang/17.0.0/lib/darwin/libclang_rt.profile_iossim.a" 2>/dev/null || true
